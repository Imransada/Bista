    ...
    <footer className="bg-slate-900 text-white py-12 md:py-16 px-4 md:px-6">
      <div className="max-w-7xl mx-auto">
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12 mb-8 md:mb-12">
            <div>
              ...
              <div className="flex space-x-4">
                <a href="https://www.facebook.com/share/14dkYCPVuba/?mibextid=wwXIfr" className="w-10 h-10 bg-slate-800 rounded-full flex items-center justify-center hover:bg-orange-600 transition-colors">
                ...
                <a href="https://www.instagram.com/bilalsada_travel_tours?igsh=OTQ3NjJ3bm5jNXM2" className="w-10 h-10 bg-slate-800 rounded-full flex items-center justify-center hover:bg-orange-600 transition-colors">
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm md:text-base text-slate-400">
                ...
                <li className="flex items-center space-x-2">
                  ...
                  <span>hello@bilalsadatravels.com</span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="border-t border-slate-800 pt-6 md:pt-8 text-center text-sm md:text-base text-slate-400">
            <p>&copy; 2026. All rights reserved. DEVELOPED BY <a href="https://arewacode.com" target="_blank" rel="noopener noreferrer" className="text-orange-500 hover:underline">AREWACODE LTD</a></p>
          </div>
        </div>
      </footer>
  );
